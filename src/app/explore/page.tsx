  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 flex flex-col gap-10">
      <div>
        ...
        <p className="mt-2" style={{ color: 'var(--ink-2)', fontFamily: 'var(--font-serif)' }}>
          Adjust the parameters, run the simulation, and explore the results.
          In large competitive fields, winners are rarely the most talented &mdash; they&apos;re usually among
          the luckiest, even when luck accounts for only a small fraction of performance.
        </p>
      </div>
